...
# syntactic error in if else statements
    if stamin > 8:
        print ("The alien is strong! It resists your pathetic attack!","random",stamin,"stamina",stamina)
    elif stamin > 5:
        print ("With a loud grunt, the alien stands firm.",stamin,stamina)
    elif stamin > 3:
        print ("Your attack seems to be having an effect! The alien stumbles!","random",stamin,"stamina",stamina)
    elif stamin> 0:
        print ("The alien is certain to fall soon! It staggers and reels!",stamin,"stamina",stamina)
    else:
        print ("That's it! The alien is finished!",stamin,"stamina",stamina)
